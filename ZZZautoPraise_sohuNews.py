...
def main(taskUrl, data_id, accountId, password, count):
    for num in range(1, int(count) + 1):
        try:
            ...
            if driver.find_element_by_xpath('//*[@id="sohu-mod"]').is_displayed():
                print('点击关闭返回主页按钮')
                ...
                driver.find_element_by_xpath('//*[@id="sohu-mod"]/div/div[2]/a').click()
            ...
            while isElementExist("//*[contains(@class,'c-comment-more')]", driver):
                ...
                time.sleep(2)
                if isElementExist(
                                        "//*[contains(@data-id," + data_id + ")]/div[2]/div[2]/div[2]/a[3]/i",
                                        driver):
                    print('找到指定评论')
                    break
                target = driver.find_element_by_xpath("//*[contains(@class,'c-comment-more')]")
            ...
            driver.find_element_by_xpath(
                "//*[contains(@data-id," + data_id + ")]/div[2]/div[2]/div[2]/a[3]/i").click()
            time.sleep(2)

            driver.find_element_by_xpath('/html/body/div[4]/div[3]/ul/li[1]/input').send_keys(
                accountId)
            time.sleep(2)
            driver.find_element_by_xpath('/html/body/div[4]/div[3]/ul/li[2]/input').send_keys(
                password)
            time.sleep(2)
            ...
            while driver.find_element_by_xpath(
                ...
                time.sleep(3)
                driver.find_element_by_xpath('/html/body/div[4]/div[3]/ul/li[3]/input').send_keys(
                    yanzhengma)
                time.sleep(3)
...
if __name__ == '__main__':
    main('http://www.sohu.com/a/167978297_267106', '258077797', '13533234158', 'abc13533234158',
         '1')
    # main('http://www.sohu.com/a/167939409_123753', '1076174855', '13533234158', 'abc13533234158', '1')
