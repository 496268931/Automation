...
try:
    ...
    driver.get("http://www.gewara.com/movie/315849910")
    ...
    time.sleep(5)
    #输入账号
    driver.find_element_by_xpath('//*[@id="loginname"]').send_keys('17031511791')
    time.sleep(2)
    #输入密码
    driver.find_element_by_xpath('//*[@id="loginpassword"]').send_keys('abc17031511791')
    time.sleep(2)
    ...
    time.sleep(2)
    #输入标题
    driver.find_element_by_xpath('//*[@id="walaTitle"]').send_keys(u'像吴京这样努力的人，必然会成功的')
    time.sleep(2)
    ...
    #输入评论内容
    driver.find_element_by_xpath('/html/body').send_keys(u'像吴京这样努力的人，必然会成功的')
    time.sleep(2)
