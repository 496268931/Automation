...
try:
    for i in MongoClient('10.26.165.77', 30000).movie.m_movies.find().limit(10):
        pass
    client = MongoClient('10.26.165.77', 30000)
except:
    client = MongoClient('59.110.10.207', 30000)

# time.sleep(1000)
r = requests.get('http://www.yinyangciqingshi.com/756.html')
# print r.content
